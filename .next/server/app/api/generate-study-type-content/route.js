(()=>{var e={};e.id=560,e.ids=[560],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},11997:e=>{"use strict";e.exports=require("punycode")},16698:e=>{"use strict";e.exports=require("node:async_hooks")},21820:e=>{"use strict";e.exports=require("os")},27910:e=>{"use strict";e.exports=require("stream")},28354:e=>{"use strict";e.exports=require("util")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},34380:(e,t,r)=>{"use strict";r.d(t,{A:()=>n});let n=(0,r(71633).fd)("postgresql://Prep-AI-Smart-Study-Material_owner:npg_5feuEw7bZcHU@ep-tight-rain-a1p8nyrb-pooler.ap-southeast-1.aws.neon.tech/Prep-AI-Smart-Study-Material?sslmode=require")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},47565:(e,t,r)=>{"use strict";r.d(t,{J0:()=>c,SX:()=>y,fU:()=>p,rJ:()=>l});var n=r(96017),a=r(61546),o=r(50033),s=r(79252),i=r(54693),u=r(34359),d=r(29334);let c=(0,a.cJ)("users",{id:(0,o.vX)().primaryKey(),name:(0,s.yf)().notNull(),email:(0,s.yf)().notNull(),isMember:(0,i.zM)().notNull().default(!1)}),l=(0,a.cJ)("studymaterial",{id:(0,o.vX)().primaryKey(),courseId:(0,s.yf)().notNull(),courseType:(0,s.yf)().notNull(),topic:(0,s.yf)().notNull(),difficultyLevel:(0,s.yf)().default("Easy"),courseLayout:(0,u.Pq)().$default("Nothing"),createdBy:(0,s.yf)().notNull(),status:(0,s.yf)().default("Generating")}),p=(0,a.cJ)("chapterNotes",{id:(0,o.vX)().primaryKey(),courseId:(0,s.yf)().notNull(),chapterId:(0,n.nd)().notNull(),notes:(0,d.Qq)()}),y=(0,a.cJ)("studyTypeContent",{id:(0,o.vX)().primaryKey(),courseId:(0,s.yf)().notNull(),content:(0,u.Pq)(),type:(0,s.yf)().notNull(),status:(0,s.yf)().default("Generating")})},50561:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>x,routeModule:()=>h,serverHooks:()=>m,workAsyncStorage:()=>f,workUnitAsyncStorage:()=>g});var n={};r.r(n),r.d(n,{POST:()=>y,dynamic:()=>p,revalidate:()=>l});var a=r(96559),o=r(48088),s=r(37719),i=r(47565),u=r(32190),d=r(34380),c=r(55220);let l=0,p="force-dynamic";async function y(e){try{let t,{chapters:r,courseId:n,type:a}=await e.json();t="flashCard"===a?`
